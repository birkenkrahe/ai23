...
- What are your thoughts on "language"? What context is necessary to
  understand language? Where would you begin to research language if
  you wanted to develop a machine learning app? What is special about
  language? Would one use the same methods to investigate the
  "language" of dolphins or whales and natural (human) language? What
  are the specific challenges for language-based machine learning? If
  your AI app customers speak a very specific, professional language,
  how would you address their concerns? Do you read much, and what
  does that do to your language understanding? Do you speak multiple
  languages, and what has the effect of this been on you?

- Example: radiologists' response to AI
  #+begin_quote
